...
2. **Відкрийте GIMP один раз, потім закрийте його** — це створює папки налаштуванб, які потрібні PhotoGIMP.
3. Завантажте останню версію:
...
1. Переконайтесь, що у вас встановлено [GIMP з офіційного сайту](https://www.gimp.org/downloads/).
2. **Відкрийте GIMP один раз, потім закрийте його** — це створює папки налаштувагь, які потрібні PhotoGIMP.
3. Завантажте останню версію:
