...
> [!IMPORTANT]
> Цей переклад зберігає інструкції з ручного встановлення випуску 3.0. Актуальні вимоги для **GIMP 3.0.x** та опис інсталятора з резервним копіюванням і відновленням наведено в [основному README](../README.md) і [документації інсталятора](../installer/README.md). У разі розбіжностей актуальним джерелом є ці документи англійською мовою.
